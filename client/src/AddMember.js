...
const AddMember = () => {
  ...
  return (
    <Form onSubmit={handleSubmit}>
        <Form.Group className="mb-5 mt-5" controlId="formBasicDodId" onChange={(e) => setDod_id(e.target.value)}>
      ...
      <Form.Group className="mb-5" controlId="formBasicLastName" onChange={(e) => setLast_name(e.target.value)}>
        <Form.Label>Last Name</Form.Label>
        <Form.Control type="l_name" placeholder="Enter Last Name" />
      </Form.Group>
      <Form.Group className="mb-5" controlId="formBasicFirstName" onChange={(e) => setFirst_name(e.target.value)}>
        <Form.Label>First Name</Form.Label>
        <Form.Control type="f_name" placeholder="Enter First Name" />
      </Form.Group>
      <Form.Group className="mb-5" controlId="formBasicEmail" onChange={(e) => setEmail(e.target.value)}>
      ...
      <Form.Group className="mb-5" controlId="formBasicAfsc" onChange={(e) => setAfsc(e.target.value)}>
